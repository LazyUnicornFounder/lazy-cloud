      ...
      <main className="relative z-10 pt-28 pb-32 px-6 md:px-12">
        <div className="max-w-3xl">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-white/[0.06] backdrop-blur-3xl rounded-3xl px-8 py-8 border border-primary/20 shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_20px_rgba(var(--primary-rgb),0.08)]"
          >
