...
const LazyGitLabPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO title="Lazy GitLab — Autonomous GitLab Docs" description="Turn every GitLab commit into a changelog entry, release notes, and a developer blog post automatically. One prompt installs the full pipeline." url="/lazy-gitlab" />
      <Navbar />
      <main className="relative z-10 pb-32">
        ...
        <section id="how-it-works" className="max-w-4xl mx-auto px-6 md:px-12 mb-20 pt-20">
          <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", color: "#f0ead6", lineHeight: "1", letterSpacing: "-0.01em" }} className="font-bold mb-8">Push to GitLab. Lazy GitLab handles the rest.</motion.h2>
        ...
        <section className="max-w-4xl mx-auto px-6 md:px-12">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="border border-border bg-card px-8 py-14 text-center">
            <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", color: "#f0ead6", lineHeight: "1", letterSpacing: "-0.01em" }} className="font-bold mb-4">Your commits are content. Lazy GitLab publishes them.</h2>
            <p className="font-body text-sm max-w-md mx-auto leading-relaxed mb-8">Every commit, merge request, and release is a story your users want to hear. Lazy GitLab writes it for you.</p>
            <CopyPromptButton text={promptText} onCopy={handlePromptCopy} />
