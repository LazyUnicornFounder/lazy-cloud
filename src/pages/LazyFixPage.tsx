...
export default function LazyFixPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO title="Lazy Fix — Autonomous Prompt Improvement" description="Every Sunday Lazy Fix reviews agent performance, spots underperformers, and opens GitHub PRs with targeted prompt improvements automatically." url="/lazy-fix" keywords="prompt improvement, autonomous fixing, Lovable prompt optimization, self-improving prompts" />
      <Navbar />
