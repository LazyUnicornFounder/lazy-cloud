  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        ...
        description="Every blog post becomes a Twitter thread, LinkedIn post, newsletter, and video script — published automatically. One piece of content, five formats."
        url="/lazy-repurpose"
