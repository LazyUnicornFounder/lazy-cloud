    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-1.5 font-body text-[11px] tracking-[0.1em] uppercase text-[#c8a961] hover:text-[#c8a961]/70 transition-colors"
        >
      ...
      {editing && (
        <div className="border border-[#f0ead6]/10 p-4 mb-6 space-y-3">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div>
              <label className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/25 block mb-1">Engine name</label>
            ...
            <div>
              <label className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/25 block mb-1">Version</label>
            ...
            <div>
              <label className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/25 block mb-1">Release date</label>
            ...
            <div>
              <label className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/25 block mb-1">Change type</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/25 block mb-1">Upgrade complexity</label>
            ...
            <div>
              <label className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/25 block mb-1">Download URL</label>
          ...
          <div>
            <label className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/25 block mb-1">Summary</label>
          ...
          <div>
            <label className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/25 block mb-1">Changes (markdown)</label>
          ...
          <div>
            <label className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/25 block mb-1">Upgrade instructions (markdown)</label>
          ...
          <div className="flex gap-2">
            <button onClick={handleSave} className="flex items-center gap-1.5 bg-[#f0ead6] text-[#0a0a08] font-display text-[10px] tracking-[0.12em] uppercase font-bold px-4 py-2 hover:opacity-90">
              <Save size={12} /> {editId ? "Update" : "Add"}
            </button>
            <button onClick={() => { setEditing(null); setEditId(null); }} className="flex items-center gap-1.5 border border-[#f0ead6]/10 font-display text-[10px] tracking-[0.12em] uppercase px-4 py-2 text-[#f0ead6]/40 hover:text-[#f0ead6]/70">
              <X size={12} /> Cancel
            </button>
          </div>
        </div>
          ...
          <thead>
            <tr className="border-b border-[#f0ead6]/8">
              {["Engine", "Version", "Date", "Type", "Complexity", "Summary", "Published", ""].map(h => (
                <th key={h} className="font-body text-[9px] tracking-[0.12em] uppercase text-[#f0ead6]/20 px-3 py-2.5 text-left">{h}</th>
              ))}
            </tr>
          </thead>
          <tbody>
            {releases.map(r => (
              <tr key={r.id} className="border-b border-[#f0ead6]/5 last:border-0">
                <td className="px-3 py-2 font-body text-[11px] text-[#f0ead6]/60">{r.engine_name}</td>
                <td className="px-3 py-2"><code className="text-[10px] bg-[#f0ead6]/5 px-1 py-0.5 text-[#f0ead6]/50">{r.version}</code></td>
                <td className="px-3 py-2 font-body text-[11px] text-[#f0ead6]/40">{r.release_date}</td>
                <td className="px-3 py-2"><span className={`text-[9px] px-1.5 py-0.5 uppercase tracking-wider ${changeTypeBadge(r.change_type)}`}>{r.change_type}</span></td>
                <td className="px-3 py-2"><span className={`text-[9px] px-1.5 py-0.5 uppercase tracking-wider ${complexityBadge(r.upgrade_complexity)}`}>{r.upgrade_complexity}</span></td>
                <td className="px-3 py-2 font-body text-[11px] text-[#f0ead6]/40 max-w-[200px] truncate">{r.summary}</td>
                ...
                <td className="px-3 py-2">
                  <button onClick={() => { setEditing(r); setEditId(r.id); }} className="text-[#f0ead6]/20 hover:text-[#f0ead6]/50">
                    <Edit2 size={12} />
                  </button>
                </td>
              </tr>
