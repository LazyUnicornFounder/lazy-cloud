...
const LazyStreamSetup = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO title="Setup — Lazy Stream" description="Connect your Twitch account and configure Lazy Stream. Set your content niche, recap style, and publishing preferences in under two minutes." url="/lazy-stream-setup" />
      <Navbar />
