  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        ...
        description="Add subscriber capture, welcome sequences, and AI-written newsletters to your Lovable project with one prompt. Powered by the Resend email API."
        url="/lazy-mail"
