    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-6">
        <Link to="/seo-blog" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
          <ArrowLeft className="w-4 h-4" /> Back to SEO Blog
        </Link>

        <div className="space-y-3">
          <h1 className="text-3xl font-bold tracking-tight">{post.title}</h1>
          <div className="flex items-center gap-3 text-sm text-muted-foreground">
            {post.target_keyword && <Badge variant="secondary">{post.target_keyword}</Badge>}
        ...
        <div className="border-t border-border pt-6 mt-8 text-sm text-muted-foreground">
          🦄 Optimised by{" "}
          <a href="https://lazyunicorn.ai/lazy-seo" className="text-primary underline hover:text-primary/80">
            Lazy SEO
          </a>{" "}
          — autonomous SEO for Lovable sites. Discover more at{" "}
