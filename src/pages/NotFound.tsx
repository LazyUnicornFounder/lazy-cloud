...
const NotFound = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background">
      <SEO title="Page Not Found" description="The page you are looking for does not exist or has been moved. Head back to the homepage to explore all autonomous agents and features." noindex={true} />
