      ...
      <main className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <section className="relative max-w-4xl mx-auto text-center px-6 pt-28 pb-24 md:mb-24">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ duration: 0.7 }}>
            ...
            <span className="inline-block bg-primary text-primary-foreground font-display text-xs md:text-sm font-extrabold uppercase tracking-[0.2em] px-5 py-1.5 rounded-full mb-6">
              BETA
            </span>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-0">
              {loopSteps.map((step, i) => (
                ...
                >
                  <span className="inline-block px-4 py-2 rounded-full border border-border bg-card/60 font-body text-xs text-foreground whitespace-nowrap">
                    {step}
                  </span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <motion.div
                variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
                transition={{ delay: 0.1 }}
                className="border border-primary/40 rounded-2xl p-6 bg-card/40"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <ul className="font-body text-sm text-muted-foreground space-y-2 flex-1">
                  <li>✓ Lazy Pay setup prompt</li>
                  <li>✓ Self-hosted in your Lovable project</li>
                  <li>✓ Bring your own Stripe account</li>
                  <li>✓ Stripe standard fees apply</li>
                </ul>
