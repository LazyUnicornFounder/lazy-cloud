...
export default function LazyWatchPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO title="Lazy Watch — Autonomous Error Monitoring" description="Lazy Watch monitors every agent error table hourly, diagnoses failures with AI, and opens GitHub issues automatically. Zero manual debugging." url="/lazy-watch" keywords="error monitoring, autonomous monitoring, Lovable error detection, GitHub issues automation" />
      <Navbar />
