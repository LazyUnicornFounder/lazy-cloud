...
export default function UpgradeGuidePage() {
  ...
  return (
    <>
      <SEO title="How to Upgrade Your Prompts" description="A practical, step-by-step guide to upgrading your Lazy prompts without breaking your site. Covers drop-in, setup-required, and breaking changes." />
      <Navbar />
