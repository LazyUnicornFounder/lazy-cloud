          ...
          <div className="max-w-4xl mx-auto text-center">
            <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ duration: 0.7 }}>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <a href="#signals" className="inline-flex items-center gap-2 px-8 py-3.5 font-display text-sm tracking-[0.15em] uppercase font-bold border border-foreground/20 text-foreground/60 hover:text-foreground hover:border-foreground/40 transition-colors">
                  See How It Works
                </a>
              </div>
            </motion.div>
