...
const LazySeoPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO title="Lazy SEO — Autonomous Search Rankings" description="Set up once and watch Google rankings climb. Lazy SEO analyses competitors, finds keyword gaps, and publishes optimised content on autopilot." url="/lazy-seo" />
      <Navbar />
      <main className="relative z-10 pb-32">
        ...
        <section className="max-w-4xl mx-auto px-6 md:px-12">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="border border-border bg-card px-8 py-14 text-center">
            <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", color: "#f0ead6", lineHeight: "1", letterSpacing: "-0.01em" }} className="font-bold mb-4">Start ranking today.</h2>
            <p className="font-body text-sm max-w-md mx-auto leading-relaxed mb-8">Every day you wait is a day your competitors publish content that outranks you.</p>
            <CopyPromptButton onCopy={handlePromptCopy} promptText={promptText} />
          </motion.div>
        </section>
      </main>
