  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        ...
        description="Access 800 million products with zero manual work. Connect AutoDS to your Lovable store and automate product discovery, pricing, and fulfilment."
        url="/lazy-drop"
