...
const BlogTicker = () => {
  ...
  return (
    <div className="w-full overflow-hidden bg-transparent border-t border-b border-primary/20 shadow-[0_-4px_20px_rgba(0,0,0,0.3),0_0_20px_rgba(var(--primary-rgb),0.08)]">
      <motion.div
