      ...
      <div className="max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <motion.div
            ...
            className="bg-white/[0.02] backdrop-blur-3xl rounded-2xl border border-primary/20 p-7 shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_20px_rgba(var(--primary-rgb),0.08)] flex flex-col"
          >
          ...
          <motion.div
            ...
            className="bg-white/[0.02] backdrop-blur-3xl rounded-2xl border border-primary/30 p-7 shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative overflow-hidden flex flex-col"
          >
            {/* Glow */}
