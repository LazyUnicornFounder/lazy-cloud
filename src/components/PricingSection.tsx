      ...
      <div className="max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <motion.div
            ...
            className="bg-background/60 backdrop-blur-2xl rounded-2xl border border-foreground/10 p-7 shadow-[0_8px_32px_rgba(0,0,0,0.4)] flex flex-col"
          >
          ...
          <motion.div
            ...
            className="bg-background/60 backdrop-blur-2xl rounded-2xl border border-primary/30 p-7 shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative overflow-hidden flex flex-col"
          >
            {/* Glow */}
