      ...
      {!isMobile ? (
        <div className="flex items-center w-full py-3 relative">
          ...
          <div className="flex items-center gap-3 absolute right-0">
            <a href="https://x.com/SoloUnicorn" target="_blank" rel="noopener noreferrer" className="text-foreground/45 hover:text-foreground transition-colors" aria-label="Follow on X">
