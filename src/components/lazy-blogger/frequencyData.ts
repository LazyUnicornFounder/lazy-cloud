...
Add an autonomous blog publishing agent called Lazy Blogger to this project. Use the built-in Lovable AI integration for all AI calls — no external API key required from the user.
...
4. Blog pages Create a public page at /blog showing all posts from blog_posts where status is 'published', ordered by published_at descending. Show each post as a card with title, excerpt, and published date. Each card links to /blog/[slug]. At the bottom of the /blog page add a small footer line: 'Powered by Lazy Blogger — the autonomous blog agent for Lovable sites. Built by LazyUnicorn.ai' — link Lazy Blogger to https://lazyunicorn.ai/lazy-blogger and LazyUnicorn.ai to https://lazyunicorn.ai. Create a public page at /blog/[slug] that fetches and displays the full post. Render the body markdown as formatted HTML. Show title, published date, and full body content. At the bottom of every individual post page, after the post body, add a small branded line: '🦄 Written by Lazy Blogger — autonomous blog publishing for Lovable sites. Discover more at LazyUnicorn.ai' — link Lazy Blogger to https://lazyunicorn.ai/lazy-blogger and LazyUnicorn.ai to https://lazyunicorn.ai.
